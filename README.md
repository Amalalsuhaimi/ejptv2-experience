...
-	انصح ببرنامج PTS الذي سبق وذكرته في الاختيارات السابقة عند الاستعداد للاختبار اذا كنت مبتدأ(يكفي عن غيره وضمان  لتجاوز الامتحان  في حال درسته جيداً بإذن الله). أما في كان لديك خلفية سابقة عن مراحل الاختراق و الادوات المستخدمة لكل مرحلة فمارس و اختبر نفسك في منصة tryhackmeو ابدأ في (CTF rooms) التي سبق ذكرها في قسم tryhackme labs. 
