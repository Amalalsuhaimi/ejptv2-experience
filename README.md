...
نوع الاختبار Open-book (أي تستطيع الرجوع للمنهج او ملاحظاتك للإستذكار واستخدام قوقل أيضاً (لن تجد إجابة مباشرة لأسئلة الامتحان ولكن قد تجد بعض الأدوات والاجراءات المساعدة في ذلك).
